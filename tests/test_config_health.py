...
class ConfigHealthTests(unittest.TestCase):
    def test_required_key_sets_are_copied(self) -> None:
        ...
        self.assertIn("sync_job_ebay_store_categories_sync_enabled", runtime_keys)
        self.assertIn("sync_job_ebay_store_categories_sync_interval_hours", runtime_keys)
        self.assertIn("sync_job_ebay_store_categories_sync_deactivate_missing", runtime_keys)
        self.assertIn("sync_job_quickbooks_export_enabled", runtime_keys)
        self.assertIn("sync_job_quickbooks_export_lookback_days", runtime_keys)
        self.assertIn("quickbooks_clearing_account_ref", runtime_keys)
        self.assertIn("quickbooks_sales_income_account_ref", runtime_keys)
        self.assertIn("quickbooks_shipping_income_account_ref", runtime_keys)
        self.assertIn("quickbooks_ebay_customer_ref", runtime_keys)
        self.assertIn("quickbooks_ebay_vendor_ref", runtime_keys)
        self.assertIn("quickbooks_ebay_payment_method_ref", runtime_keys)
        self.assertIn("quickbooks_ebay_fee_expense_account_ref", runtime_keys)
        self.assertIn("quickbooks_ebay_shipping_expense_account_ref", runtime_keys)
        self.assertIn("quickbooks_ebay_subscription_expense_account_ref", runtime_keys)
        self.assertIn("quickbooks_ebay_adjustment_expense_account_ref", runtime_keys)
        self.assertIn("quickbooks_tax_code_ref", runtime_keys)
        self.assertIn("quickbooks_doc_number_prefix", runtime_keys)
        env_keys.add("X")
        runtime_keys.add("Y")
